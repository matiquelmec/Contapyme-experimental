...
export default function PurchaseBookPage() {
  ...
  const [newDocument, setNewDocument] = useState<NewPurchaseData>({
  ...
  const fetchDocuments = async () => {
    try {
      ...
      const response = await fetch(`/api/accounting/purchase-book?${params}`);
  ...
  const handleCreateDocument = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/accounting/purchase-book', {
        method: 'POST',
        headers: {
      ...
      if (data.success) {
        setMessage('Documento de compra creado exitosamente');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header 
        ...
        subtitle="Gestión de documentos de compra y IVA crédito fiscal"
        showBackButton
        actions={
          <Button 
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-8 text-gray-500">
                <p>No hay documentos de compra registrados</p>
                {selectedPeriod && (
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="border-b bg-gray-50">
                      ...
                      <th className="text-left p-3 text-sm font-medium text-gray-700">Proveedor</th>
                      ...
                      <tr key={doc.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="p-3 text-sm">
                          <div>
                            ...
                            {doc.supplier_rut && (
                              <p className="text-xs text-gray-500">RUT: {doc.supplier_rut}</p>
                            )}
                          </div>
                        </td>
          ...
          <div className="bg-white rounded-lg max-w-md w-full max-h-screen overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold">Nuevo Documento de Compra</h2>
                <button
              ...
              <form onSubmit={handleCreateDocument} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={newDocument.supplier_name}
                    onChange={(e) => { setNewDocument(prev => ({ ...prev, supplier_name: e.target.value })); }}
                    required
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={newDocument.supplier_rut}
                    onChange={(e) => { setNewDocument(prev => ({ ...prev, supplier_rut: e.target.value })); }}
