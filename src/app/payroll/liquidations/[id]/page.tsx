...
export default function LiquidationDetailPage() {
  ...
  const getActionButtons = () => {
    ...
    availableActions.forEach(targetStatus => {
      switch (targetStatus) {
        ...
        case 'draft':
          // Diferenciar entre rechazar desde review y revertir desde approved
  ...
  const handleEdit = () => {
    ...
    if (confirmed) {
      // Redirigir a generación con parámetros de edición
        ...
        <PayrollHeader 
          ...
          actions={
            <div className="w-full space-y-4">
              ...
              {/* Botones contextuales mejorados - glass effect */}
              <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
                ...
                {liquidation.status === 'draft' && (
                  <>
                    ...
                    <button
                      onClick={handleSubmitForReview}
                      disabled={updatingStatus}
                      className="group relative px-4 py-2.5 rounded-xl bg-green-500/10 hover:bg-green-500/20 border border-green-500/20 hover:border-green-500/40 backdrop-blur-sm transition-all duration-200 flex items-center gap-2 text-green-600 hover:text-green-700 font-medium disabled:opacity-50"
                    >
                    ...
                    <button
                      onClick={handleDelete}
                      disabled={updatingStatus}
                      className="group relative px-4 py-2.5 rounded-xl bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 hover:border-red-500/40 backdrop-blur-sm transition-all duration-200 flex items-center gap-2 text-red-600 hover:text-red-700 font-medium disabled:opacity-50"
                    >
                ...
                {liquidation.status === 'review' && (
                  <>
                    ...
                    <button
                      onClick={handleRevertToDraft}
                      disabled={updatingStatus}
                      className="group relative px-4 py-2.5 rounded-xl bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/20 hover:border-orange-500/40 backdrop-blur-sm transition-all duration-200 flex items-center gap-2 text-orange-600 hover:text-orange-700 font-medium disabled:opacity-50"
                    >
                ...
                {liquidation.status === 'approved' && (
                  <>
                    <button
                      onClick={handleMarkAsPaid}
                      disabled={updatingStatus}
                      className="group relative px-4 py-2.5 rounded-xl bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 hover:border-blue-500/40 backdrop-blur-sm transition-all duration-200 flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium disabled:opacity-50"
                    >
                    ...
                    <button
                      onClick={handleAnnulLiquidation}
                      disabled={updatingStatus}
                      className="group relative px-4 py-2.5 rounded-xl bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 hover:border-red-500/40 backdrop-blur-sm transition-all duration-200 flex items-center gap-2 text-red-600 hover:text-red-700 font-medium disabled:opacity-50"
                    >
                ...
                {liquidation.status === 'paid' && (
                  <button
                    disabled
                    className="group relative px-4 py-2.5 rounded-xl bg-gray-500/10 border border-gray-500/20 backdrop-blur-sm transition-all duration-200 flex items-center gap-2 text-gray-500 font-medium cursor-not-allowed"
                  >
                    <Eye className="w-4 h-4" />
                    <span className="text-sm">Liquidación Finalizada</span>
                  </button>
                )}
