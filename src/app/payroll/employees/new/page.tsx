...
export default function NewEmployeePage() {
  ...
  const autoCompletePrevisionalData = async (rut: string) => {
    ...
    if (rut.length >= 11 && !formData.pensionFund && !formData.healthInsurance && payrollOptions) {
      console.log('🎯 Autocompletando datos previsionales con valores predeterminados');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateForm()) {
      ...
      if (errors.rut || errors.fullNames || errors.firstSurname || errors.birthDate || errors.email) {
        setActiveTab('basic-info');
      } else if (errors.position || errors.startDate || errors.baseSalary || errors.entryTime || errors.exitTime || errors.lunchBreakDuration || errors.healthInsurance || errors.pensionFund) {
    ...
    try {
      ...
      // Redirigir directamente a la lista de empleados
      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="space-y-6">
          <form onSubmit={handleSubmit}>
            ...
            {/* Basic Information Tab - Personal + Contact */}
            {activeTab === 'basic-info' && (
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/20">
                <div className="border-b border-white/20 p-6">
                  ...
                  <p className="text-gray-600">Datos personales y de contacto del empleado</p>
                </div>
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Contact Information in Same Tab */}
              ...
              <div className="space-y-6">
                <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/20">
                  <div className="border-b border-white/20 p-6">
                    ...
                    <p className="text-gray-600">Información del contrato y configuración previsional</p>
                  </div>
                  <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                ...
                {/* Payroll Configuration in Same Tab */}
                <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/20">
                  <div className="border-b border-white/20 p-6">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-xl font-semibold text-gray-900">Configuración Previsional</h3>
                    </div>
                    <p className="text-gray-600">AFP y sistema de salud</p>
                  </div>
                  <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                ...
                {activeTab !== 'work-info' ? (
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      const tabs = ['basic-info', 'work-info'];
